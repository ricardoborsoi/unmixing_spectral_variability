% -------------------------------------------------------------------------
% This code executes the Jasper Ridge example of the DeepGUn algorithm,  
...
load('data/real_data_jasperRidge.mat')
