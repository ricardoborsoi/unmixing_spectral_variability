% -------------------------------------------------------------------------
% This code executes example 4 of the DeepGUn algorithm, referring to 
...
axes(ha(1));
title('Asphalt','interpreter','latex','fontsize',12)
axes(ha(2));
title('Tree','interpreter','latex','fontsize',12)
axes(ha(3));
title('Roof','interpreter','latex','fontsize',12)
axes(ha(4));
title('Metal','interpreter','latex','fontsize',12)
axes(ha(5));
title('Dirt','interpreter','latex','fontsize',12)
