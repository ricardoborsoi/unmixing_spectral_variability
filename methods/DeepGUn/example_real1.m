% -------------------------------------------------------------------------
% This code executes the Houston example of the DeepGUn algorithm, referring 
...
% materials are: vegetation, red roofs, concrete, and asphalt
load('data/real_data_houston.mat')
